(() => {
      ...
      // e.magnificPopup.registerModule("image", {
        ...
        // proto: {
          ...
          // getImage: function (i, o) {
            ...
            // }
            // return (
              // t._parseMarkup(o, { title: j(i), img_replaceWith: i.img }, i),
              // t.resizeImage(),
              // i.hasSize
                // ? (M && clearInterval(M),
                  // i.loadError
          ...
          // initRetina: function () {
            // if (window.devicePixelRatio > 1) {
              // var e = t.st.retina,
                // i = e.ratio;
              // (i = isNaN(i) ? i() : i) > 1 &&
                // (k("ImageHasSize." + F, function (e, t) {
                  // t.img.css({
                    // "max-width": t.img[0].naturalWidth / i,
                    // width: "100%",
                  // });
                // }),
                // k("ElementParse." + F, function (t, o) {
  ...
  const o = document.querySelector(".header__icon-menu"),
    s = document.querySelector(".header__menu");
  o &&
    o.addEventListener("click", function () {
      o.classList.toggle("_active"), s.classList.toggle("_active");
    }),
